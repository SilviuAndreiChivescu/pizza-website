    ...
    <header>
      <div className="container-fluid p-2 black-bg d-flex justify-content-between">
          ...
          >
            <div className="m-4 p-4 shadow bg-white">
              ...
              <div style={{ lineHeight: "1.2" }} className="pt-2">
                ...
                >
                  <p>
                    <i className="fas fa-lg fa-phone-square me-2"></i>0754 911
                    062
                  </p>
                </a>
                <a
                ...
                >
                  <p>
                    <i className="fas fa-lg fa-phone-square me-2"></i>0790 649
                    803
                  </p>
                </a>
              </div>
        ...
        <h5
          ...
          className="d-inline p-2 text-secondary ms-5"
        >
          Nu există sentiment mai plăcut în lume decât o cutie de pizza caldă pe
          picioare.
        </h5>
        <Drawer

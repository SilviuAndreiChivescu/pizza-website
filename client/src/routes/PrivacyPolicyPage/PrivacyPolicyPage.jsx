...
export default function PrivacyPolicyPage() {
  return (
    <Container>
      <h1>Privacy Policy for Medieval Pizza</h1>

      <p>
        At Medieval Pizza, accessible from www.medievalpizza.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Medieval Pizza and how we use it.
      </p>
      ...
      <p>
        Medieval Pizza legal basis for collecting and using the personal
      ...
      <ul>
        <li>Medieval Pizza needs to perform a contract with you</li>
        <li>You have given Medieval Pizza permission to do so</li>
        <li>
          Processing your personal information is in Medieval Pizza legitimate
          interests
        </li>
        <li>Medieval Pizza needs to comply with the law</li>
      </ul>

      <p>
        Medieval Pizza will retain your personal information only for as long as
      ...
      <p>
        Medieval Pizza follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Medieval Pizza uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of Medieval Pizza.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Medieval Pizza, which are sent
      ...
      <p>
        Note that Medieval Pizza has no access to or control over these cookies
      ...
      <p>
        Medieval Pizza's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Medieval Pizza does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in Medieval Pizza. This policy is not applicable
